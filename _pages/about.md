...
My research interests focus on **Human-Centered NLP**, with a particular emphasis on: i) `Social-Aware and Trustworthy NLP`; ii) `NLP for Computational Social Science`; and iii) `Augmenting Humans with LLMs`.
