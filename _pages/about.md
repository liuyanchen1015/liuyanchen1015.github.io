...
My research interests focus on **Human-Centered NLP**, with a specific emphasis on: i) `Social-Aware and Trustworthy NLP`; ii) `NLP for Computational Social Science`; and iii) `Augmenting Humans with LLMs`.
