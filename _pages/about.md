...
My research interests focus on **Human-Centered NLP**, particularly: i) `Social-Aware and Trustworthy NLP`; ii) `NLP for Computational Social Science`; and iii) `Augmenting Humans with LLMs`.
