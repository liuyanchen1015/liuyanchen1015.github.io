...
My research interests lie in <span style="color:blue">**Human-Centered NLP**</span>, with a particular focus on: i) `LLM for More Research`, esp. `LLM4CSS` & `LLM4Linguistics`; ii) `Linguistics4LLM`; iii) `Multilingual & Linguistic Variations`; iv) `Trustworthy NLP` and v) `LLM Agents & Simulations`.
