...
My research interests lie in **Human-Centered NLP**, particularly: i) `dialect-inclusive and trustworthy NLP`; ii) `empowering linguistic research with LLMs`; iii) `understanding LLM's behaviors from linguistic perspectives` and iv) `CSS and LLM for CSS`.
