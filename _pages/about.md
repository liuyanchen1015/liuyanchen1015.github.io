...
My research interests lie in **Human-Centered NLP**, with a particular focus on: i) `multilingual and dialect-inclusive NLP`; ii) `trustworthy NLP`;  iii) `understanding LM's behaviors from linguistic lens` and iv) `empowering CSS and linguistic research with LLMs`.
