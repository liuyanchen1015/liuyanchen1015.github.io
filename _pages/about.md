...
**Research Interests:** My primary research interests are focused on NLP, with a particular emphasis on LLMs' 1) `Efficiency` adapter, prompting, in-context learning; 2) `Reliability and Fairness` social biases, toxicity and other social impacts.
