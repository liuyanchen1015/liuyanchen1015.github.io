...
Hi all! I am a 1st-year PhD student at [MIT](https://www.mit.edu/) <img src="assets/img/MIT.png" alt="mit" height="14px"> [IDSS](https://idss.mit.edu/) and [CSAIL](https://www.csail.mit.edu/), advised by Prof. [Dylan Hadfield-Menell](https://people.csail.mit.edu/dhm/). My research is generously supported by [MIT Michael Hammer Fellowship](https://idss.mit.edu/academics/ses/ses-funding/hammer-fellows/).
...
My research interests mainly lie in `scalable supervision` and `scalable oversight`, i.e., how to train and oversee superhuman-level AI systems.
