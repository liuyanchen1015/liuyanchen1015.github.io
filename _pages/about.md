...
My research interests lie in **Human-Centered NLP**, with a particular focus on: i) `dialect-inclusive NLP`; ii) `empowering CSS and linguistics with LLMs`; iii) `LLM agents & simulations` and iv) `trustworthy NLP`.
