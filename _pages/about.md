...
**Research Interests:** My primary research interests are focused on NLP, with a particular emphasis on LLMs' i) `Efficiency:` adapters, prompting, in-context learning; ii) `Fairness`; iii) and other `Social Impacts`.
