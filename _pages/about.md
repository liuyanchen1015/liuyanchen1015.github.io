...
**Research Interests:** My research interests are focused on **Human-Centered NLP**, with a particular emphasis on: i) `social-aware and trustworthy NLP`; ii) `NLP for CSS`; and iii) `augmenting humans with LLMs`.
