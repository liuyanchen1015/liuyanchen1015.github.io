...
These results not only corroborate the conclusions drawn from previous survey-based studies <d-cite key="van2022misinformation"></d-cite><d-cite key="Nan2022WhyPeopleBelievea"></d-cite> but also provide further validation for the effectiveness of our computational modeling for susceptibility.
