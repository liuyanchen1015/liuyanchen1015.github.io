...
**Data Statistics** of our constructed training dataset. We show the statistics for the number of the user-tweet pairs (*# Example*), unique users (*# User*), and unique misinformation tweets (*# Misinfo tweet*) in the overall dataset and in the positive and negative subsets.
...
**Table: Comparison with Human Judgement**
...
This is a trend that has been observed in various research where political ideology influences the perception of scientific information \cite{mccright2013influence, baptista2021influence, imhoff2022conspiracy}.
